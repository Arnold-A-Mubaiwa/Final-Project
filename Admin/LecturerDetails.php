...
for (i = 0; i < tr.length; i++) {gvc uhnj8 9hb9ui98y777787
...
<body>
<div>
<a href="Lecturers.php" class="btn">Back</a>
...
<div>
    <fieldset id="pers">
       ...
       <label> Lecturer Number :</label> <?php echo $row["LecturerNumber"]; ?><br>
       ...
       <label>Register Name :</label>  <a href="Register.php"><?php echo $row["TableName"]; $_SESSION['table'] = $row["TableName"]; ?></a> click to view register<br>
    </fieldset>
    <fieldset id="Attendance">
        ...
        <span id="uniCode"> <label>Unique Code:</label > <?php echo  $row['UniqueNumber']; ?></span><br>
        
    </fieldset>
    <fieldset id="big-field">
